...
This is a Huginn-13B-GPTQ starter template from [Banana.dev](https://www.banana.dev) that allows on-demand serverless GPU inference.
...
1. [Fork this](https://github.com/bananaml/demo-huginn-13b-gptq/fork) repository to your own Github account.
